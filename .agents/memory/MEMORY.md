...
- [Invoice and payment child rows](invoice-payment-child-rows.md) — use child rows for financial truth; check audits need payee-first invoice resolution and in-file reservations.
